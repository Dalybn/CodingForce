...
//////////////////////////////////////////
/*void supprimer_employe(char *cin)1*
{
FILE *f;
FILE *c;
...
c=fopen("tempo.txt","a");
    ...
    if (f!=NULL)
    {1*       */
//printf("Donnez la CIN de l'employe a supprimer");
   // scanf("%s",s.cin);
 /*   2**while (fscanf(f,"%s %s %s %s %s %s %s \n",E.nom,E.prenom,E.cin,E.date_naissance,E.numero,E.adresse,E.poste)!=EOF)
    {
	if(strcmp(cin,E.cin)!=0)
        {
fprintf(c,"%s %s %s %s %s %s %s \n",E.nom,E.prenom,E.cin,E.date_naissance,E.numero,E.adresse,E.poste);
...
rename("tempo.txt","employe.txt");
	...
	/*void supprimer_employe(char cin1[])
	{
...
employe E ;
f=fopen("employe.txt","r");
f1=fopen("tmp.txt","w+");//mode lecture et ecriture
while(fscanf(f,"%s %s %s %s %s %s %s \n",E.nom,E.prenom,E.cin,E.date_naissance,E.numero,E.adresse,E.poste)!=EOF){
if(strcmp(cin1,E.cin)!=0)fprintf(f1,"%s %s %s %s %s %s %s \n",E.nom,E.prenom,E.cin,E.date_naissance,E.numero,E.adresse,E.poste);
}
fclose(f);
fclose(f1);
remove("employe.txt");
...
t=fopen("temp.text","a");
    ...
    if (f!=NULL || t!=NULL)
    { 
	/*printf("Donnez la CIN de l'employe a modifie: \n");
    	scanf("%s",s.cin);*/
